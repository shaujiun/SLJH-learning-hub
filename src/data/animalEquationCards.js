...
export const animalEquationRuleCards = [
  {
    code: 'flow',
    title: '遊戲流程',
    summary: '四人圍桌，房主每局設定 40～60 分；4 張動物或達標即可獲勝。',
    steps: [
      '遊戲固定 4 個座位；可由 1～4 位真人進入，其餘空位在開始時由 AI 自動補滿。',
      '每位玩家取得 6 張私人手牌，中央隨機放置 16 張蓋住的動物卡。每人擲 2 顆骰子，總和最高者先出牌；同點者重擲。',
      '每回合可出根號牌，或使用 1 張功能牌。',
      '完成出牌後自動補回 6 張，再輪到下一位玩家。',
      '牌庫不足時，系統會自動洗回棄牌。',
      '房主每局設定通關分數為 40、45、50、55 或 60 分；取得 4 張動物，或分數達標，任一條件成立即獲勝。',
      '同房下一局保留各玩家勝場；4 位真人都明確離開後，房間與勝場結束。',
    ],
  },
  {
    code: 'radical',
    title: '出根號牌',
    summary: '基礎可出 1～2 張；進階可用 3～6 張組成方程式。',
    steps: [
      '出 1 張任意根號牌。',
      '出 2 張化簡後為同類方根的根號牌。',
      '房主選進階玩法後，出 3～6 張根式牌時，必須用＋、－、×、÷、括號與恰好 1 個等號組成成立的方程式。',
      '被選入等式的每張牌都要使用 1 次，不能漏用或重複使用。',
      '基礎出牌的 n 牌不必輸入係數；進階方程式中每張 n 牌可各自填不同的 1～9。',
      '方程式使用根式精確值判定，不用小數近似。',
  ...
  },
  {
    ...
    steps: [
      ...
      '抓錯期間出牌區公開實際牌面；若無人抓錯，牌進棄牌區並補牌。錯誤且被成功抓出時，原牌回手、不補牌。',
